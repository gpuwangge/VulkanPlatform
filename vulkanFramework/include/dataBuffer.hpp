...
enum UniformTypes {
    ...
    COMPUTE_UNIFORMBUFFER_CUSTOM =   0x00000080,
    COMPUTE_STORAGEBUFFER_DOUBLE =   0x00000100,
    COMPUTE_STORAGEIMAGE_TEXTURE =   0x00000200,
    COMPUTE_STORAGEIMAGE_SWAPCHAIN = 0x00000400
};
