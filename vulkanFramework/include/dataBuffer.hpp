...
enum UniformTypes {
    ...
    GRAPHCIS_COMBINEDIMAGESAMPLER_DEPTHIMAGE =      0x00000020,
    
    COMPUTE_UNIFORMBUFFER_CUSTOM =   0x00000040,
    COMPUTE_STORAGEBUFFER_DOUBLE =   0x00000080,
    COMPUTE_STORAGEIMAGE_TEXTURE =   0x00000100,
    COMPUTE_STORAGEIMAGE_SWAPCHAIN = 0x00000200
};
